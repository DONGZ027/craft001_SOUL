...
page = st_navbar(
    ['Scenario Planning', 'Budget Minimizing', 'Attendee Maximizing'],
    logo_path=logo_path,
    # urls=urls,
    styles=styles,
    options=options
...
# Background Image
# =====================================================================================================================
img = get_img_as_base64("static/images/baymax_face.png")
...
functions = {
    ...
    "Budget Minimizing": pg.show_minimization,
